...
String.prototype.format || (String.prototype.format = function () {
    ...
    e.fn.datagrid = function (t, n) {
        var r = this, i = "success", s = e(this), o = function (t) {
            ...
            if (a)for (var l = 0, c = a.length; l < c; l++)f += u(i, a[l], r);
        ...
        t == "loadData" && a();
        if (t == "getData")return s.data("rows");
        if (t == "getConfig")return s.data("config");
        if (t == "getColumns")return s.data("config").columns;
