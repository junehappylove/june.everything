		...
		long dwCookie, VARIANT_BOOL* OnConnection)
{
	...
	//  be localized.
   {
      LPCTSTR szCommand = _T("AddFileToProject");
	   VARIANT_BOOL bRet;
	   CString strCmdString;
	   strCmdString.LoadString(IDS_CMD_ADD);
	   strCmdString = szCommand + strCmdString;
	   CComBSTR bszCmdString(strCmdString);
	   CComBSTR bszMethod(_T("AddFileToProject"));
   ...
   {
	   LPCTSTR szCommand = _T("OpenFile");
	   VARIANT_BOOL bRet;
	   CString strCmdString;
	   strCmdString.LoadString(IDS_CMD_OPEN);
	   strCmdString = szCommand + strCmdString;
	   CComBSTR bszCmdString(strCmdString);
	   CComBSTR bszMethod(_T("OpenFile"));
	   CComBSTR bszCmdName(szCommand);
